...
@Autonomous(name = "Left Mid", group = "My OpMode")
public class AutoLeftMidOpMode extends CommandOpMode {
    ...
    public void initialize() {
        ...
        // Create Commands
        m_auto = new AutoMid(this,m_drive, m_lift, m_claw, m_color, m_arm, Direction.LEFT);
